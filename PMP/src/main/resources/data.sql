...
insert into property (id, area, description, name, number_of_room, price,status,type, address_id) values ( '1', 76, 'Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.', 'Safe Harbor', 1, 143,false,'Sell',1);
insert into property (id, area, description, name, number_of_room, price,status,type, address_id)  values ('2', 68, 'Aenean lectus. Pellentesque eget nunc.  condimentum.', 'Mills LLC', 3,  174,false,'Sell',2);
insert into property (id, area, description, name, number_of_room, price,status,type, address_id)  values ( '3', 43, 'Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros. ',' Country Side', 5, 63,false,'Rent',3);
insert into property (id, area, description, name, number_of_room, price,status,type, address_id)  values ('4', 35, 'Quisque id justo sit amet sapien dignissim vestibulum. ','Sheraton palace', 5, 90,true,'Sell',4);
insert into property (id, area, description, name, number_of_room, price,status,type, address_id)  values ('5', 99, 'Morbi non lectus. Aliquam sit amet diam in magna bibendum imperdiet. ', 'Acianda Bella' , 4, 89,true,'Sell',5);
insert into property (id, area, description, name, number_of_room, price,status,type, address_id)  values ('6', 58, 'Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros.','Special Grande', 5, 187,false,'Rent',6);
insert into property (id, area, description, name, number_of_room, price,status,type, address_id)  values ('7', 73, 'Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo mauris, laoreet ut,', 'Grand Bololo', 4, 63,false,'Rent',7);
insert into property (id, area, description, name, number_of_room, price,status,type, address_id)  values ('8', 38, 'Maecenas ut massa quis augue luctus tincidunt. Nulla mollis molestie lorem.  ','Grady-Prosacco' , 3, 76,false,'Sell',8);
insert into property (id, area, description, name, number_of_room, price,status,type, address_id)  values ( '9', 84, 'Maecenas leo odio, condimentum id, luctus nec, molestie sed,','Watsica-Konopelski', 2, 101,true,'Rent',1);
insert into property (id, area, description, name, number_of_room, price,status,type, address_id)  values ('10', 77, ' sed, tristique in, tempus sit amet, sem.Fusce consequat. Nulla nisl. Nunc nisl.', 'Renner Inc', 1, 66,true,'Rent',2);
